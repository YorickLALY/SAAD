# -*- coding: utf-8 -*-
"""
Created on Fri Mar 12 08:46:51 2021
...
if learning_on == 1:
    ...
    for epoch in range(10):
        ...
        for i, data in enumerate(trainloader,0):
            ...
            torch.save(net,'Autoencoder_pred_MinMaxScaler.pt')
    ...
    plt.xlabel('Epoch')   
    plt.ylabel('Loss')
    plt.title('Evolution of the loss through the epoch for Autoencoder MinMaxScaler')
    plt.show()
else:
    net = torch.load('Autoencoder_pred_MinMaxScaler.pt')  #Load an existing network
