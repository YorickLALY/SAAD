# -*- coding: utf-8 -*-
"""
Created on Wed Jan  6 10:37:47 2021
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(8,256,3,padding=1)
        self.conv2 = nn.Conv1d(256,196,3,padding=1)
        self.conv3 = nn.Conv1d(196,136,3,padding=1)
        self.conv4 = nn.Conv1d(136,76,3,padding=1)
        self.conv5 = nn.Conv1d(76,14,3,padding=1)
        self.conv6 = nn.Conv1d(14,76,3,padding=1)
        self.conv7 = nn.Conv1d(76,136,3,padding=1)
        self.conv8 = nn.Conv1d(136,196,3,padding=1)
        self.conv9 = nn.Conv1d(196,256,3,padding=1)
        self.conv10 = nn.Conv1d(256,8,3,padding=1)
...
if learning_on == 1:
    input_signal = batch[0:35000]
    prediction_signal = batch[40:35040]
    ...
    for epoch in range(10):
        ...
        for i, data in enumerate(trainloader,0):
            ...
            torch.save(net,'Autoencoder_1DCNN.pt')
    ...
    plt.xlabel('Epoch')   
    plt.ylabel('Loss')
    plt.title('Evolution of the loss through the epoch for Autoencoder 1D-CNN 30 min runs')
    plt.show()
else:
    net = torch.load('Autoencoder_1DCNN.pt')  #Load an existing network
