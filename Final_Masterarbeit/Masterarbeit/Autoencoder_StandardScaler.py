# -*- coding: utf-8 -*-
"""
Created on Fri Mar 12 11:12:28 2021
...
if learning_on == 1:
    ...
    for epoch in range(30):
        ...
        for i, data in enumerate(trainloader,0):
            ...
            torch.save(net,'Autoencoder_pred_StandardScaler.pt')
    ...
    plt.xlabel('Epoch')   
    plt.ylabel('Loss')
    plt.title('Evolution of the loss through the epoch for Autoencoder StandardScaler')
    plt.show()
else:
    net = torch.load('Autoencoder_pred_StandardScaler.pt')  #Load an existing network
